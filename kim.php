		...
		<body>
			...
			<article>
				...
				<div class="intro-container">
					<p>Hello, my name is Eunlim Kim. I am a senior majoring in computer science, and my particular interest is Human Computer Interaction (HCI). I was born in South Korea and came to United States when I was 15 years old. I want to use my knwoledge in HCI to help people who has disadvantages.</p>
				</div>
				...
				<h2>Early Years</h2>
					...
					<h3>Education background</h3>
						<ol>
							<li>
								2004-2010:
								<ul><li>Korean Elementary School</li></ul>
							</li>
							<li>
								2010-2011:
								<ul><li>Korean Middle Shcool </li></ul>
							</li>
							<li>
								2012-2016:
								<ul><li>Saint Mary Academy in Rhode Island</li></ul>
							</li>
							<li>
								2017-Now:
