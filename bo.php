			...
			<div class="container">
				<article>
					...
					<figure class="intro-selfie">
						<img src="images/bo-selfie.jpg" alt="Bo's selfie" class="space-img">
					</figure>
					...
					<ol>
						<li>1999-2016:
							<ul>
								<li>Regular Chinese Schools</li>
							</ul>
						</li>
						<li>2016-2017:
							<ul>
								<li>English as second Language Program in University of Illinions at Springfield</li>
							</ul>
						</li>
						<li>2017-2019:
							<ul>
								<li>Bachelor of Computer Science at Saint Louis University</li>
							</ul>
						</li>
						<li>2020-Now:
							<ul>
								<li>Bachelor of Computer Science at University of Rochester</li>
							</ul>
						</li>
					</ol>
					<h2>Major Course List</h2>
					<ol>
						<li>In Saint Louis University (2017-2019):
							<ol>
						...
						<li>In Univesity of Rochester (2019-2020):
							<ol>
